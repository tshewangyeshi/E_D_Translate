...
//
//   npm run build
//   node scripts/export-segments.mjs --tier1 ".fees" --private ".profile" page1.html page2.html > segments.json
//
...
if (files.length === 0) {
  console.error("usage: export-segments.mjs [--tier1 SEL]... [--private SEL]... page.html...");
  process.exit(2);
}
...
const pages = files.map((file) => {
  ...
  if (doc.documentElement.hasAttribute("data-dz-private")) {
    return { file, skipped: "data-dz-private", segments: [] };
  }
